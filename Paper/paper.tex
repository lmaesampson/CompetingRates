...
The 2014 DHS in DRC included a sero survey that was limited to children between the ages of 6-59 months.  

That survey provides only a limited perspective on the immunity in older age classes.  The case data, however DO provide this information.  This raises the question of what is the marginal benefit of conducting a sero survey. 

very little marginal benefit in terms of assessing relative risk -- the age-specfic case data and vaccination coverage data do a good job of estimating the rank order of risk.

However, as illustrated in the simulation study, the sero survey allows more confident estimates of the rank order of vaccine effectiveness.  

Limitations -- the model requires some significant assumptions that are almost certainly violated.

Applications -- design of sero surveys.

Periodic assessment of sero-prevalence. 
